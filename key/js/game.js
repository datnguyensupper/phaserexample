...
TheGame.prototype = {
    ...
    createFloor:function(floor,floorLevelWall){
        ...
        for(var j = 0; j < floorLevelWall.length; j++){
            ...
            var spike = game.add.tileSprite(gameOptions.floorX + floorLevelWall[j].x,
                gameOptions.floorY[floor], floorLevelWall[j].width,floorLevelWall[j].height,"tile");
...
TheBootGame.prototype = {
    ...
    create: function() {
        ...
        var progressBG = game.add.tileSprite(800, 300, 300, 20, "tile");

        var progress = game.add.tileSprite(progressBG.x, progressBG.y, 0, progressBG.height, "tile");
...
TheLoadingGame.prototype = {
    init:function(progress,progressBG,theSquare){
        ...
        game.time.events.add(loadingTime, function(){
            game.state.start(
                "TheGame",
                true, // clearWorld
                false // clearCache
    ...
    preload: function(){
        ...
        ManagerForSound.loadSound(game, 'jump', 'assets/sounds/Jump.wav');
